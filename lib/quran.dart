...
///```
Map searchWords(List<String> words, { Rasm rasm = Rasm.uthmani }) {
  List<Map> result = [];
...
extension RasmExtension on Rasm {
  String get value {
    switch (this) {
      case Rasm.uthmani:
        return "uthmani";
